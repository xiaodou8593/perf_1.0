#perf:macro/execute_4_rotate/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class macro/execute_4_rotate

tellraw @a "--- macro/execute_4_rotate perf result ---"
