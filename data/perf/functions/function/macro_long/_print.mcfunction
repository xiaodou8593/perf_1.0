#perf:function/macro_long/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class function/macro_long

tellraw @a "--- function/macro_long perf result ---"
