#perf:fill/macro/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class fill/macro

tellraw @a "--- fill/macro perf result ---"
...
scoreboard players operation sstemp int %= sstemp1 int
